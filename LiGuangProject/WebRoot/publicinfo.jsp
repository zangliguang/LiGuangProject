...
<html>
  <head>
    ...
    <title>My JSP 'publicinfo.jsp' starting page</title>
...
　　}
  ...
  <body onbeforeunload="checkLeave()">
	<form  method="post"  onsubmit="saveInformation()"
    enctype="multipart/form-data" class="dropzone"
    id="dropzoneForm" name ="dropzoneForm">
     <input type="hidden" name="filetype" id="filetype" value="123"/>
    <div align="center">
    <input type="text" name ="information.subject" value ="主题"><br>
    <input type="text" name ="information.content" value ="内容"><br>
    <input type="text" name ="information.bid" value ="<%=bid%>" ><br>
